...
import 'package:pharmacia/controllers/language_controller.dart';

class Language extends StatefulWidget {
  const Language({Key? key}) : super(key: key);

  @override
  State<Language> createState() => _LanguageViewState();
}

class _LanguageViewState extends State<Language> {
        ...
        body: Padding(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final isSelected = controller.selectedLanguage == languageCode;

              return GestureDetector(
                onTap: () {
                  setState(() {
                    controller.updateSelectedLanguage(languageCode);
                  });
                },
                child: Container(
